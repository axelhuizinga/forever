 ...
 */
function forever_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'forever_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.forever-front-page) .entry-title,
...
.colors-custom .forever-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.forever-front-page .panel-content .recent-posts article,
...
.colors-custom.forever-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'forever_custom_colors_css', $css, $hue, $saturation );
}
